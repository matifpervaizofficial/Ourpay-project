...
List<WAWalkThroughModel> waWalkThroughList() {
  ...
  list.add(WAWalkThroughModel(
      title: "Easy Loans",
      description:
          "Get loan of upto Rs. 7 lakhs for all your needs at 0% processing fee and without any collateral Enjoy lower than market interest rates, easy application process & quick disbursal!",
      image: 'assets/easyloan.jpg'));
  list.add(WAWalkThroughModel(
      title: "Single Qr Code",
      description:
          "Accept payments from any UPI app - PhonePe, PayTM, Google Pay, BHIM and 150+ others with your BharatPe QR. Payments get settled in your bank account.",
      image: 'assets/Qrcode.png'));
  list.add(WAWalkThroughModel(
      title: "Safe Transaction",
      description: "We makes safe and fast transactions for you ;).",
      image: 'assets/fsttra.jpg'));
...
List<WABillPayModel> waSelectBillList() {
  ...
  list.add(WABillPayModel(
      title: 'Bank of Pakistan', image: 'assets/wa_bank_of_america.png'));
